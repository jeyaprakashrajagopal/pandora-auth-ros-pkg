...
(cl:in-package gui_communications-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <targetPosition>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'targetPosition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gui_communications-msg:<targetPosition> is deprecated: use gui_communications-msg:targetPosition instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <targetPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gui_communications-msg:x-val is deprecated.  Use gui_communications-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <targetPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gui_communications-msg:y-val is deprecated.  Use gui_communications-msg:y instead.")
  (y m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<targetPosition>)))
  ...
  "gui_communications/targetPosition")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'targetPosition)))
  "Returns string type for a message object of type 'targetPosition"
  "gui_communications/targetPosition")
